...
export default async function Sidebar() {
    return (
        <div className=" flex w-64 flex-col border-r border-gray-300">
                ...
                <div className="flex flex-col justify-between flex-1 h-full px-4">
                    <div className="space-y-4">
                        <div>
                            <Button
                                variant="outline"
                                className="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold leading-5 transition-all duration-200 bg-blue text-white border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 hover:bg-regalblue hover:text-slate-50"
                            >
