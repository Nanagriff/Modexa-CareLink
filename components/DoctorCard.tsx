                ...
                <div className="flex items-center gap-4 py-4">
                  ...
                  <Image className='h-24 w-24 rounded-full object-cover'
                        ...
                        width={243} alt='DoctorImg'
                         height={207} />
                         <p className='bg-lightblue bottom-0 right-1 absolute w-10  flex items-center 
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="bg-green-300 text-[10px] py-2 font-medium hover:bg-green-200 px-2 uppercase">
                            Available today
                        </p>
                    </div>
                </div>
