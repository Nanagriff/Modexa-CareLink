  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-2/3 space-y-6">
        {showNotification && (
          <Alert color="failure" className=" text-red-500 bg-red-100" icon={HiInformationCircle}>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel> Please Enter Token Here</FormLabel>
              <FormControl>
        ...
        <Button className="bg-blue" type="submit">Submit</Button>
      </form>
    </Form>
  );
}